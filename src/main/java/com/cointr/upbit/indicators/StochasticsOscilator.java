...
public class StochasticsOscilator {
    ...
    public double getStochasticFastK(List<TradeInfoDto> data, int currentIndex, int n) {
    ...
    public double getStochasticSlowK(List<TradeInfoDto> data, int currentIndex, int n) {
        double sumFastK = 0;
    ...
    public double getStochasticSlowD(List<TradeInfoDto> data, int currentIndex, int n) {
        double sumSlowK = 0;
